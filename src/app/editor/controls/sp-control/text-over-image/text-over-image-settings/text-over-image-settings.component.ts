...
@Component({
  ...
  templateUrl: './text-over-image-settings.component.html',
  styleUrls: ['./text-over-image-settings.component.scss']
})
export class TextOverImageSettingsComponent extends SettingsComponent implements OnInit {
