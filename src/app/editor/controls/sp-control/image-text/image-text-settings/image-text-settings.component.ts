...
@Component({
  ...
  templateUrl: './image-text-settings.component.html',
  styleUrls: ['./image-text-settings.component.scss']
})
export class ImageTextSettingsComponent extends SettingsComponent implements OnInit {
